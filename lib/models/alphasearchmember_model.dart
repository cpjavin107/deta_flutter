class AlphaMemberModel {
  ...
  AlphaMemberModel.fromJson(Map<String, dynamic> json){
    status = json['status'];
    msg = json['msg'];
...
class Data {
  Data({
    ...
    required this.dealsIn_3,
    required this.dealsIn_4,
    required this.dob,
  ...
  Data.fromJson(Map<String, dynamic> json){
    ...
    dealsIn_3 = json['deals_in_3'];
    dealsIn_4 = json['deals_in_4'];
    dob = json['dob'];
